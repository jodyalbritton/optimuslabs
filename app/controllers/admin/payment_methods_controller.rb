class Admin::PaymentMethodsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @payment_method.save
        format.html { redirect_to admin_payment_method_path(@payment_method), notice: 'Rate type was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @payment_method.update(payment_method_params)
        format.html { redirect_to admin_payment_method_path(@payment_method), notice: 'Rate type was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to payment_methods_url, notice: 'Rate type was successfully destroyed.' }
  ...
  private
    ...
    def payment_method_params
      params.require(:payment_method).permit(:name, :description, :position, :payment_method_id)
    end
end
